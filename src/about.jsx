    ...
    return <>
        <Divone>
            ...
            <div className="contactus" align="center">
                ...
                {/* <i>e-mail: </i> */}
                <input type='email' className='inputtag' placeholder='e-mail' required />
                <br />
                <input type='text' className='inputtag' placeholder='Your_Name' required />
                <br />
                {/* <i>Message: </i> */}
                <textarea type='text' className='inputmsg' placeholder='Please enter your message here...' required rows={4} cols={30} />
                <br />
